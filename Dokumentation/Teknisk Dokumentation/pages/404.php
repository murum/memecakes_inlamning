...
<body>
	<div class="container">
		...
		<div class="content">
			...
			<h2>404.php</h2>
			<p>404 Sidan är en template för vart användaren kommer när man har matat in en sida som inte finns.</p>
			<p>Oftast så kommer användaren till 404 sidan när man har besökt en gammal länk eller försöker manipulera URLen själv.</p>
		</div>
